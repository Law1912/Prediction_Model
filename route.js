...
async function runPipeline() {
  try {
    const { today, lastScrapedDate } = await scrapeTweets();
...
// Run the script every day at 12 AM
cron.schedule("0 0 * * *", async () => {
  console.log("⏳ Running daily tweet scraping job...");
  await runPipeline();
});

console.log("🚀 Daily tweet scraper initialized, waiting for schedule...");
